...
class _AttendanceState extends State<Attendance> {
  ...
  String DefaultDept;
  String Defaultuser;
  String Defaultmonth = global.month;
  String Defaultyear = global.year;
  List Users = List();
  List Departments = List();
  List Month = [{'id':1,'name': 'Jan'},{'id':2,'name': 'Feb'},{'id':3,'name': 'Mar'},{'id':4,'name': 'Apr'},{'id':5,'name': 'May'},{'id':6,'name': 'Jun'},{'id':7,'name': 'Jul'},{'id':8,'name': 'Aug'},{'id':9,'name': 'Sep'},{'id':10,'name': 'Oct'},{'id':11,'name': 'Nov'},{'id':12,'name': 'Dec'}];
  List Year = [
                {'id':2015,'name':'2015'},
                {'id':2016,'name':'2016'},
                {'id':2017,'name':'2017'},
  ...
  void fetchAttendance() async {
    ...
    Map<String, String> headers = {"Content-type": "application/json","ibckey":Userdetail[0]['key']};
    String json = '{"department": "'+DefaultDept+'", "employee": "'+Userdetail[0]['ecode']+'","month":"'+Defaultmonth+'","year":"'+Defaultyear+'"}';
